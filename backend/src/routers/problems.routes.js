...
problemsRoutes.get("/delete-problem/:id", authMiddleware, checkAdmin, deleteProblem);
problemsRoutes.get("/get-solved-problems", authMiddleware, getAllProblemSolvedByUser)
